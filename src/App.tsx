    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 transition-colors duration-200 dark:bg-gray-900 dark:text-gray-100">
      <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/90 backdrop-blur dark:border-gray-700 dark:bg-gray-800/90">
        <div className="mx-auto max-w-7xl px-3 sm:px-4">
          <div className="flex items-center justify-between gap-3 border-b border-gray-200/80 py-2.5 dark:border-gray-700/80">
            <nav
              className="flex items-center gap-1 rounded-lg bg-gray-100 p-1 dark:bg-gray-700/50"
              aria-label="主导航"
            >
              <button
                type="button"
          ...
          {activeTab === "b" && (
            <div className="py-3 sm:py-3.5">
              <h1 className="text-base font-bold text-gray-900 sm:text-lg dark:text-gray-100">页面 B</h1>
              <p className="mt-0.5 text-[11px] text-gray-600 sm:text-xs dark:text-gray-400">扩展功能占位</p>
            </div>
          )}
        </div>
      </header>
